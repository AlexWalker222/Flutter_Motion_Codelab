...
import 'export/alex_export.dart';
                    ...
                    InkWell(
                      ...
                      child: Row(
                        children: [
                          ...
                          // Added fade through transition between disappearing mailbox title (Motion)
  ...
  Widget build(BuildContext context) {
    return Consumer<EmailStore>(
      builder: (context, model, child) {
        ...
        // Added Fade through transition between bottom app bar actions (Motion)
...
class _ReplyFabState extends State<_ReplyFab>
  ...
  // Added Fade through transition between compose and reply FAB (Motion)
